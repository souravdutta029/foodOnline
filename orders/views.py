...
def place_order(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            order.save() #geneated order id or pk
...
def payments(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest' and request.method == "POST":
        ...
        # move the cart items to OrderedFood model
        ...
        mail_subject = 'Thank you for placing order with us!'
        ...
        # send order confirmation email to vendors
        ...
        for i in cart_items:
            if i.fooditem.vendor.user.email not in to_emails:
                ...
                ordered_food_vendor = OrderedFood.objects.filter(order=order, fooditem__vendor=i.fooditem.vendor)
        ...
        # clear the cart if payment is done
        cart_items.delete()
        
        # Return back to ajax with response success or failed
        response = {
